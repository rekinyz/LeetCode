...
public class BestTimeToBuyAndSellStock3Test {
	...
	public void testMaxProfit1() {
		...
		assertEquals(stock.maxProfit(input), 7);
	}
	...
	public void testMaxProfit4() {
		...
		assertEquals(stock.maxProfit(input), 1);
	}

	@Test
	public void testMaxProfit5() {
		int[] input = {}; // 0
		assertEquals(stock.maxProfit(input), 0);
	}
	...
	public void testMaxProfit7() {
		...
		assertEquals(stock.maxProfit(input), 6);
	}

	@Test
	public void testMaxProfit8() {
		int[] input = { 1, 2, 4 }; // 3 = 4-1
		assertEquals(stock.maxProfit(input), 3);
	}
	...
	public void testMaxProfit12() {
		...
		assertEquals(stock.maxProfit(input), 11);
	}

	@Test
	public void testMaxProfit13() {
		int[] input = { 1, 2, 4, 2, 5, 7, 2, 4, 9, 0 }; // 13 = 7-1 + 9-2
		assertEquals(stock.maxProfit(input), 13);
	}
}
