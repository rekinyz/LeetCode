...
public class BinaryTreePreorderTraversalTest {
	...
	public void testPreorderTraversal1() {
		...
		assertEquals(Arrays.asList(5, 4, 11, 7, 2, 8, 13, 1, 4), preorderTraversal(input));
	}

	@Test
	public void testPreorderTraversal2() {
		Integer[] input = { 0, 4, 8, 11, null, 13, 4, 7, 2, null, null, null, null, null, 1 };
		assertEquals(Arrays.asList(0, 4, 11, 7, 2, 8, 13, 4, 1), preorderTraversal(input));
	}

	@Test
	public void testPreorderTraversal3() {
		Integer[] input = { 1, null, 2, null, null, 3 };
		assertEquals(Arrays.asList(1, 2, 3), preorderTraversal(input));
	}

	@Test
	public void testPreorderTraversal4() {
		Integer[] input = { 1, -2, -3, 1, 3, -2, null, -1 };
		assertEquals(Arrays.asList(1, -2, 1, -1, 3, -3, -2), preorderTraversal(input));
	}
