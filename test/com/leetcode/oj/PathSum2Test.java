...
public class PathSum2Test {
    ...
    public void testPathSum1() {
    	Integer[] input = {5};;
    	assertEquals(pathSum(input, 5).get(0), Arrays.asList(5));
    }
    @Test
    public void testPathSum2() {
    	Integer[] input = {-2,-3,-3};
    	assertEquals(pathSum(input, -5).get(0), Arrays.asList(-2, -3));
    	assertEquals(pathSum(input, -5).get(1), Arrays.asList(-2, -3));
    }
    @Test
    public void testPathSum3() {
    	Integer[] input = {5,4,8,11,null,13,4,7,2,null,null,null,1};
    	assertEquals(pathSum(input, 22).get(0), Arrays.asList(5, 4, 11, 2));
    }
    @Test
    public void testPathSum4() {
    	Integer[] input = {5,4,8,11,null,13,4,7,2,null,null,null,null,5,1};
    	assertEquals(pathSum(input, 22).get(0), Arrays.asList(5, 4, 11, 2));
    	assertEquals(pathSum(input, 22).get(1), Arrays.asList(5, 8, 4, 5));
    }
    @Test
    public void testPathSum5() {
    	Integer[] input = {};
    	assertEquals(pathSum(input, 1), Arrays.asList());
    }
    @Test
    public void testPathSum6() {
    	Integer[] input = {1,-2,-3,1,3,-2,null,-1};
    	assertEquals(pathSum(input, 2).get(0), Arrays.asList(1, -2, 3));
    }
