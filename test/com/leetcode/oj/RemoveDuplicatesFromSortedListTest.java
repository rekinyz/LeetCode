...
public class RemoveDuplicatesFromSortedListTest {
	...
	public void testDeleteDuplicates0() {
		int[] array = { 2, 3, 3 };
		assertEquals(Arrays.asList(2, 3), deleteDuplicates(array).toList());
	}

	@Test
	public void testDeleteDuplicates1() {
		int[] array = { 0, 1, 1, 2, 2, 3, 3 };
		assertEquals(Arrays.asList(0, 1, 2, 3), deleteDuplicates(array).toList());
	}

	@Test
	public void testDeleteDuplicates2() {
		int[] array = { 1, 1, 1, 1, 2, 3, 4, 4 };
		assertEquals(Arrays.asList(1, 2, 3, 4), deleteDuplicates(array).toList());
	}

	@Test
	public void testDeleteDuplicates3() {
		int[] array = { 1, 2, 4, 5, 6, 7, 7 };
		assertEquals(Arrays.asList(1, 2, 4, 5, 6, 7), deleteDuplicates(array).toList());
	}

	@Test
	public void testDeleteDuplicates4() {
		int[] array = { 0, 1, 2, 4, 5, 6, 7 };
		assertEquals(Arrays.asList(0, 1, 2, 4, 5, 6, 7), deleteDuplicates(array).toList());
	}

	@Test
	public void testDeleteDuplicates5() {
		int[] array = { 2, 3, 4, 4, 5 };
		assertEquals(Arrays.asList(2, 3, 4, 5), deleteDuplicates(array).toList());
	}

	@Test
	public void testDeleteDuplicates6() {
		int[] array = { 0, 0 };
		assertEquals(Arrays.asList(0), deleteDuplicates(array).toList());
	}

	@Test
	public void testDeleteDuplicates7() {
		int[] array = { 0, 1 };
		assertEquals(Arrays.asList(0, 1), deleteDuplicates(array).toList());
	}
	...
	public void testDeleteDuplicates9() {
		...
		assertEquals(Arrays.asList(0, 1, 2, 3, 4), deleteDuplicates(array).toList());
	}
